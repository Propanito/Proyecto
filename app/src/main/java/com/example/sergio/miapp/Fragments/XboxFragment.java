...
public class XboxFragment extends Fragment implements View.OnClickListener, SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_xbox, container, false);
        mContext = getActivity();
    ...
    private void getWebservice(final String s) {
        final Request request = new Request.Builder().url("https://api.fortnitetracker.com/v1/profile/xbox/"+s).header("TRN-Api-Key", "f85627ed-3968-41ec-b182-bf5af72cb54d").get().build();
